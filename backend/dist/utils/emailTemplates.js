...
exports.policyEmailTemplate = exports.quoteEmailTemplate = void 0;
// ------------------------
...
// ------------------------
const quoteEmailTemplate = ({ quoteNumber, firstName, totalPremium, }) => {
    return {
                ...
                <div class="email-wrapper">
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p><strong>Total Estimated Premium:</strong> <span class="highlight">$${totalPremium != null
...
exports.quoteEmailTemplate = quoteEmailTemplate;
// ------------------------
...
// ------------------------
const policyEmailTemplate = ({ policyNumber, firstName, quoteNumber, totalPremium, }) => {
    return {
        ...
        html: `
            ...
            : ""}
                            ${totalPremium != null
            ? `<p><strong>Total Premium Paid:</strong> $${totalPremium.toFixed(2)}</p>`
            : ""}
