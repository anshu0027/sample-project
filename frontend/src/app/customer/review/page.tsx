...
async function validateRetrievedQuoteFields(quoteNumber: string): Promise<boolean> {
  try {
    ...
    const requiredFields = ["eventType", "eventDate", "maxGuests", "coverageLevel", "liabilityCoverage", "venueName", "venueAddress1", "venueCountry", "venueCity", "venueState", "venueZip", "firstName", "lastName", "email"] as const;
