...
export default function QuoteDetail() {
    ...
    if (error) {
        return <div className="p-4 sm:p-8 max-w-7xl mx-auto"><div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">{error}</div></div>;
    }
    if (!quote) {
        return <div className="p-4 sm:p-8 max-w-7xl mx-auto"><div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg">No quote found with ID #{id}.</div></div>;
    }
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mt-1">
                                    <span className="text-xs sm:text-sm text-gray-500">Created {quote.createdAt ? new Date(quote.createdAt).toLocaleDateString() : "-"}</span>
                ...
                {/* Quote Summary */}
                <div className="bg-white shadow-sm rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                    <h2 className="text-base sm:text-lg font-semibold mb-4 text-gray-900 border-b pb-2">Quote Summary</h2>
                        ...
                        <div className="bg-blue-50 rounded-lg p-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-semibold">{quote.eventDate ? new Date(quote.eventDate).toLocaleDateString() : "-"}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-green-50 rounded-lg p-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-semibold">{quote.coverageLevel !== null && quote.coverageLevel !== undefined ? `Level ${quote.coverageLevel}` : "-"}</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-indigo-50 rounded-lg p-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-semibold">${quote.totalPremium !== null && quote.totalPremium !== undefined ? quote.totalPremium : "-"}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div className="bg-white shadow-sm rounded-xl p-4 sm:p-6 lg:col-span-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm sm:text-base font-medium">{quote.liabilityCoverage || "-"}</p>
                            </div>
                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Host Liquor Liability</h3>
                                <div className="mt-1 flex items-center">
                                    {quote.liquorLiability ?
                                        <><Wine size={16} className="text-green-500 mr-1" /> <span className="text-sm sm:text-base font-medium">Included</span></> :
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex items-center">
                                    {quote.specialActivities ?
                                        <><Activity size={16} className="text-amber-500 mr-1" /> <span className="text-sm sm:text-base font-medium">Yes</span></> :
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex items-center">
                                    {quote.covidDisclosure ?
                                        <><AlertTriangle size={16} className="text-amber-500 mr-1" /> <span className="text-sm sm:text-base font-medium">Yes</span></> :
                                        <span className="text-sm sm:text-base font-medium">No</span>
                                    }
                                </div>
                            </div>
                            <div>
                                ...
                                <p className="mt-1 text-sm sm:text-base font-medium">${quote.basePremium !== null && quote.basePremium !== undefined ? quote.basePremium : "-"}</p>
                            </div>
                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Liability Premium</h3>
                                <p className="mt-1 text-sm sm:text-base font-medium">${quote.liabilityPremium !== null && quote.liabilityPremium !== undefined ? quote.liabilityPremium : "-"}</p>
                            </div>
                            {quote.liquorLiability && (
                                <div>
                                    <h3 className="text-sm font-medium text-gray-500">Host Liquor Liability Premium</h3>
                                    <p className="mt-1 text-sm sm:text-base font-medium">${quote.liquorLiabilityPremium !== null && quote.liquorLiabilityPremium !== undefined ? quote.liquorLiabilityPremium : "-"}</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white shadow-sm rounded-xl p-4 sm:p-6">
                        <h2 className="text-base sm:text-lg font-semibold mb-4 text-gray-900 border-b pb-2">Contact Information</h2>
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Policy Holder</h3>
                                <p className="mt-1 text-sm sm:text-base font-medium">{quote.firstName || "-"} {quote.lastName || "-"}</p>
                            </div>
                            <div>
                                <h3 className="text-sm font-medium text-gray-500">Email</h3>
                                <p className="mt-1 text-sm sm:text-base font-medium break-words">{quote.email || "-"}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-sm sm:text-base font-medium">{quote.city || "-"}, {quote.state || "-"} {quote.zip || "-"}</p>
                ...
                <div className="bg-white shadow-sm rounded-xl p-4 sm:p-6 mt-4 sm:mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        <div>
                            ...
                            <p className="mt-1 text-sm sm:text-base font-medium">{quote.honoree1FirstName && quote.honoree1LastName ? `${quote.honoree1FirstName} ${quote.honoree1LastName}` : "-"}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Honoree 2 Name</h3>
                            <p className="mt-1 text-sm sm:text-base font-medium">{quote.honoree2FirstName && quote.honoree2LastName ? `${quote.honoree2FirstName} ${quote.honoree2LastName}` : "-"}</p>
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <p className="text-sm sm:text-base font-medium">{quote.venueAddress1 || "-"} {quote.venueAddress2 ? `, ${quote.venueAddress2}` : ""}</p>
                            <p className="text-sm sm:text-base font-medium">{quote.venueCity || "-"}, {quote.venueState || "-"} {quote.venueZip || "-"}</p>
